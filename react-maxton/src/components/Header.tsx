        ...
        <Nav className="gap-1 nav-right-links align-items-center">
                ...
                {notifications.slice(0, 5).map((notification) => (
                  ...
                  >
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <div className="">
                        <h5 className="notify-title">{notification.title}</h5>
                        <p className="mb-0 notify-desc">
                          {notification.message}
                        </p>
                        <p className="mb-0 notify-time">{notification.time}</p>
                      </div>
                    </div>
                  </Dropdown.Item>
                ))}
          ...
          <Dropdown as={Nav.Item}>
            ...
            <Dropdown.Menu className="dropdown-user shadow">
              ...
              <Dropdown.Item className="d-flex align-items-center gap-2 py-2">
                <i className="material-icons-outlined">local_bar</i>Settings
              </Dropdown.Item>
              <Dropdown.Item className="d-flex align-items-center gap-2 py-2">
